...
import fr.gouv.monprojetsup.suggestions.server.controllers.SuggestionsControllers
...
@ContextConfiguration(
    classes = [
        ...
        SuggestionsControllersTest::class,
        EdgesRepository::class,
        EdgeJPARepository::class,
    ]
)
@WebMvcTest(controllers = [SuggestionsControllers::class])
