...
import fr.gouv.monprojetsup.data.domain.model.onisep.formations.FormationAvecMetier;
...
public record FilieresToFormationsOnisep(
    ...
    public record FormationOnisep(
        ...
        public FormationOnisep(String ideo, @NotNull fr.gouv.monprojetsup.data.domain.model.onisep.formations.FormationOnisep f) {
            this(
                    ideo,
                    null,
                    null,
    ...
    public static FilieresToFormationsOnisep getFilieres(
        ...
        Map<String, fr.gouv.monprojetsup.data.domain.model.onisep.formations.FormationOnisep> formationsPerKey
                = formationsOnisep.formations().stream().distinct()
                .collect(Collectors.toMap(
                        fr.gouv.monprojetsup.data.domain.model.onisep.formations.FormationOnisep::identifiant,
                        f -> f
                ));
