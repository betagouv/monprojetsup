...
public class Constants {
    ...
    private static final String CENTRE_INTERET_MPS_PREFIX = "ci";//like g_ta_cod
    ...
    public static boolean isCentreInteretMps(@NotNull String key) {
        return key.startsWith(CENTRE_INTERET_MPS_PREFIX);
    }
