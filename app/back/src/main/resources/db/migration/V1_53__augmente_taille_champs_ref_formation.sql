DROP VIEW expanded_label;
DROP VIEW expanded_keywords;

ALTER TABLE ref_formation ALTER COLUMN label_details TYPE VARCHAR;
ALTER TABLE ref_formation ALTER COLUMN label TYPE character varying (2053);
