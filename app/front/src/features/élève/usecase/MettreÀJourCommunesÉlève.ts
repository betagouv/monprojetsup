import { CommuneFavorite, type Élève } from "@/features/élève/domain/élève.interface";
...
export class MettreÀJourCommunesÉlèveUseCase {
  ...
  public async run(élève: Élève, communesÀModifier: CommuneFavorite[]): Promise<Élève | Error> {
