...
const CarteTémoignageÉlève = ({ children, auteur, rôle, entête }: CarteTémoignageÉlèveProps) => {
  return (
    <div className="h-full border border-l-4 border-solid border-[--border-default-grey] border-l-[#FB926B] bg-white px-10 py-8 md:px-14 md:py-12">
      <div className="grid grid-flow-row gap-2">
        <img
          ...
          src={temoignageSVG}
        />
        {entête && <p className="fr-text--lead mb-0 font-bold text-[--text-active-grey]">{entête}</p>}
