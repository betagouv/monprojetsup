...
import { type FormationÉlève } from "@/features/élève/domain/élève.interface";
...
export default function useAmbition() {
  ...
  const ambitions: Array<{ niveau: NonNullable<FormationÉlève["niveauAmbition"]>; emoji: string; libellé: string }> = [
    {
      niveau: 1,
  ...
  const mettreAJourAmbition = (niveauAmbition: FormationÉlève["niveauAmbition"]) => {
