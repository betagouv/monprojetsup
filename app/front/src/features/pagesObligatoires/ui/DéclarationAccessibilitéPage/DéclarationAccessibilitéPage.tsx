...
const DéclarationAccessibilitéPage = () => {
  return (
    <>
      <Head titre={i18n.PAGE_DÉCLARATION_ACCESSIBILITÉ.TITRE_PAGE} />
      <div className="fr-container pb-20 pt-12 [&_h2]:mb-2 [&_h2]:pt-5">
        ...
        <p>
          {i18n.APP.NOM} est non conforme avec le référentiel général d’amélioration de l’accessibilité (RGAA), version
          4.
