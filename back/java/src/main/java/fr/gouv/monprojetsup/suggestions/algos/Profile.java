...
import fr.gouv.monprojetsup.web.db.DBTools;
import fr.gouv.monprojetsup.web.db.model.Message;
...
public final class Profile {
    ...
    @NotNull private Map<String, Suggestion> choices = new HashMap<>();
            ...
            update.suggestions().forEach(suggestion -> {
                ...
                if(fl != null) {
                    ...
                    if (status == null) {
                        ...
                        Suggestion current = choices.getOrDefault(fl, new Suggestion(
                                fl,
                                null,
                                suggestion.date(),
                                suggestion.status(),
                        ...
                        choices.put(fl.replace(".", "_"), Suggestion.getSuggestion(current, suggestion.status()));
                    }
                }
            });
        }
    ...
    private String toExplanationString(List<Suggestion> suggestions) {
