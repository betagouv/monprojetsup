...
@Service
public class AppGetSimpleStatsService extends MyAppService<AppGetSimpleStatsService.Request, AppGetSimpleStatsService.Response> {

    public AppGetSimpleStatsService() {
        super(Request.class);
    }
