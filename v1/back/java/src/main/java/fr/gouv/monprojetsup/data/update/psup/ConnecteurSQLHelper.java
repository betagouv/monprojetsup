...
public class ConnecteurSQLHelper {
    ...
    public static ConnecteurSQL getConnecteur(ConnectionParams params) throws AccesDonneesException {
        if(params.disableFan) {
            try {
                ...
                throw new AccesDonneesException(AccesDonneesExceptionMessage.MESSAGE, e, e.getMessage());
            }
