...
import static fr.gouv.monprojetsup.suggestions.infrastructure.model.stats.PsupStatistiques.MIN_POPULATION_SIZE_FOR_STATS;
import static fr.gouv.monprojetsup.suggestions.infrastructure.model.stats.PsupStatistiques.MOYENNE_BAC_CODE;
import static fr.gouv.monprojetsup.suggestions.infrastructure.model.stats.StatistiquesAdmisParMatiere.getStatAgregee;
...
public class PsupStatistiques implements Serializable {
     ...
     * @return pair bac, stat
     */
    public Pair<String, @NotNull Statistique> getStatScol(String groupe, int matiere, String bac) {
    ...
    public void updateLabels(OnisepData onisepData, PsupData psupData) {
        labels.putAll(
                Labels.getLabels(
                        this.nomsFilieres,
                        psupData,
