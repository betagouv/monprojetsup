...
public class DataSources {
    ...
    public static final String SPECIALITES_FILENAME = "parcoursup/nbAdmisParSpecialite.json";
    ...
    public String getFrontSrcPath() {
        return rootDirectory + "frontendData.zip";
    }

    /* one of the data files used by the server */
    public String getBackDataFilePath() {
        return rootDirectory + "backendData.zip";
    }
