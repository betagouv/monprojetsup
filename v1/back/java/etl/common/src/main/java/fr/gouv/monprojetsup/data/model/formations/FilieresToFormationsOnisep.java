...
import fr.gouv.monprojetsup.data.onisep.formations.Formation;
import fr.gouv.monprojetsup.data.onisep.formations.FormationAvecMetier;
import fr.gouv.monprojetsup.data.onisep.formations.Formations;
import fr.gouv.monprojetsup.data.onisep.formations.FormationsAvecMetiers;
...
public record FilieresToFormationsOnisep(
    ...
    public record FormationOnisep(
        ...
        public FormationOnisep(String ideo, @NotNull fr.gouv.monprojetsup.data.onisep.formations.Formation f) {
            this(
                    ideo,
                    null,
                    null,
