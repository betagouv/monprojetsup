package fr.gouv.monprojetsup.suggestions.infrastructure.model.thematiques;
...
import fr.gouv.monprojetsup.suggestions.infrastructure.onisep.ThematiquesOnisep;
import lombok.val;
...
public record Thematiques(
    ...
    public static Thematiques loadThematiques(DataSources sources) throws IOException {
        ThematiquesOnisep thematiquesOnisep = ThematiquesOnisep.loadThematiquesOnisep(sources);
