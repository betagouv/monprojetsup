...
public record OnisepData(
    ...
    public static OnisepData fromFiles(DataSources sources) throws IOException {
    ...
    public Map<String, Set<String>> getMetiersVersFormationsExtendedWithGroupsAndLASAndDescriptifs(
        ...
        metiersVersFormations.entrySet().forEach(e -> {
            Set<String> mpsFormationsKeys = new HashSet<>(e.getValue());
            e.setValue(mpsFormationsKeys);
            mpsFormationsKeys.forEach(mpsKey -> {
                mpsFormationsKeys.add(mpsKey);
