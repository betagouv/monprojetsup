package fr.gouv.monprojetsup.data.infrastructure;
...
public class DataSources {
    ...
    public static final String CRITERES_FILENAME = "parcoursup/criteres.json";
    ...
    /* the data file downloaded by the front clients of the poc */
    public String getFrontSrcPath() {
        return dataRootDirectory + "frontendData.zip";
    }

    /* one of the data files used by the server */
    public String getBackDataFilePath() {
        return dataRootDirectory + "backendData.zip";
    }
