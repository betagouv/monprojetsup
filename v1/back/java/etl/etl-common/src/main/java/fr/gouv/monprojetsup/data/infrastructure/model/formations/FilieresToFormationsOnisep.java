package fr.gouv.monprojetsup.data.infrastructure.model.formations;

import fr.gouv.monprojetsup.data.infrastructure.onisep.billy.PsupToOnisepLines;
import fr.gouv.monprojetsup.data.infrastructure.onisep.formations.FormationAvecMetier;
import fr.gouv.monprojetsup.data.infrastructure.onisep.formations.FormationsAvecMetiers;
import fr.gouv.monprojetsup.data.infrastructure.onisep.formations.FormationsOnisep;
...
import static fr.gouv.monprojetsup.data.domain.Constants.FILIERE_PREFIX;
...
public record FilieresToFormationsOnisep(
    ...
    public record FormationOnisep(
        ...
        public FormationOnisep(String ideo, @NotNull fr.gouv.monprojetsup.data.infrastructure.onisep.formations.FormationOnisep f) {
            this(
                    ideo,
                    null,
                    null,
    ...
    public static FilieresToFormationsOnisep getFilieres(
        ...
        Map<String, fr.gouv.monprojetsup.data.infrastructure.onisep.formations.FormationOnisep> formationsPerKey
                = formationsOnisep.formations().stream().distinct()
                .collect(Collectors.toMap(
                        fr.gouv.monprojetsup.data.infrastructure.onisep.formations.FormationOnisep::identifiant,
                        f -> f
                ));
