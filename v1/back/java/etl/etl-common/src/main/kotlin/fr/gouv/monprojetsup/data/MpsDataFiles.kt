...
import fr.gouv.monprojetsup.data.domain.labels.Labels
...
import fr.gouv.monprojetsup.data.infrastructure.model.bacs.BacsLoader
import fr.gouv.monprojetsup.data.infrastructure.model.descriptifs.DescriptifsFormationsMetiers
import fr.gouv.monprojetsup.data.infrastructure.model.descriptifs.DescriptifsLoader
import fr.gouv.monprojetsup.data.infrastructure.model.descriptifs.UrlsUpdater
...
import fr.gouv.monprojetsup.data.infrastructure.model.specialites.SpecialitesLoader
...
import fr.gouv.monprojetsup.data.infrastructure.rome.RomeData
...
class MpsDataFiles(
    ...
    private fun load() {
        ...
        onisepData = OnisepData.fromFiles(dataSources)

        logger.info("Chargement des données ROME")
        romeData = RomeData.load(dataSources)
    ...
    override fun getBacs(): List<Bac> {
        return BacsLoader.load(dataSources)
    }
