...
public class UpdateScrapFormations implements CommandLineRunner {
    ...
    @Autowired
    public UpdateScrapFormations(DataSources sources, ServerData serverData) {
    ...
    public void run(String... args) throws Exception {
        ...
        for (Map.Entry<String, String> entry : serverData.liensOnisep().entrySet()) {
            ...
            Serialisation.toJsonFile(sources.getSourceDataFilePath(DataSources.ONISEP_DESCRIPTIFS_FORMATIONS_PATH), descriptifs, true);
        }
    }
