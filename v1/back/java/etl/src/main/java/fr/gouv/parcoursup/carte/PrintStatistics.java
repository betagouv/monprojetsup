...
import static fr.gouv.parcoursup.carte.modele.modele.JsonCarte.*;
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (Reader r = new InputStreamReader(Files.newInputStream(Paths.get("data/psupdata.json")))) {
            ...
            System.out.println(String.join(System.lineSeparator(),
                    data.groupes[IDX_TYPE_ETAB].getItems().size() + " types d'établissements",
                    data.groupes[IDX_TYPE_FORMATION].getItems().size() + " types de formations",
                    data.groupes[IDX_MENTION].getItems().size() + " mentions et spécialités",
