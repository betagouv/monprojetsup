...
public record FichesMetierOnisep(
    ...
    public static FichesMetierOnisep load() throws IOException {
        FichesMetierOnisep orig = Serialisation.fromJsonFile(DataSources.getSourceDataFilePath(DataSources.ONISEP_FICHES_METIERS), FichesMetierOnisep.class);
