package fr.gouv.monprojetsup.suggestions.data.model.descriptifs;
...
import fr.gouv.monprojetsup.suggestions.data.update.onisep.SecteursPro;
...
import static fr.gouv.monprojetsup.suggestions.data.model.descriptifs.Descriptifs.Descriptif.mergeDescriptifs;
...
public record Descriptifs(
    ...
    public void inject(MetiersScrapped metiersScrapped) {
        metiersScrapped.metiers().values().forEach(m -> {
            String cs = Constants.cleanup(m.key());
