...
FROM  A_REC_GRP@dbl_arch rec, A_REC@dbl_arch arec,G_ETA eta, SP_G_TRI_AFF  formations  WHERE rec.g_ta_cod=formations.g_ta_cod AND rec.g_ta_cod=arec.g_ta_Cod AND eta.g_ea_cod=formations.g_ea_cod_aff ORDER BY G_FL_COD_AFF,C_GP_COD;
