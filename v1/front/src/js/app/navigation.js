...
export function registerEnterHandler(screen, handler) {
  screen_enter_handlers[screen] = handler;
}

export function registerExitHandler(screen, handler) {
  screen_exit_handlers[screen] = handler;
}
